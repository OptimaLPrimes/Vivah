  ...
  return (
    <section id="home" className="relative h-screen min-h-[800px] w-full flex items-center justify-center text-center text-white p-4">
      ...
      <div className="relative z-10 flex flex-col items-center animate-fade-in-up gap-4">
        <h1 className="font-headline text-3xl md:text-4xl text-primary/90 tracking-widest">
          ॥ श्री गणेशाय नमः ॥
        </h1>
        ...
        <p className="font-body text-lg md:text-xl font-semibold text-foreground/80 mb-6">
